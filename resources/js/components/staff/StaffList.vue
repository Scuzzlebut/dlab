<template>
    <main-container>
        <material-card icon="fas fa-building-user" :title="$t('staff.list_title')" :main_action="main_action" @mainAction="createStaff" noduplicate :selected="selected_staff" @unselectAll="selected_staff=[]">
